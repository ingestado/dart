// an extended polygon class with my own customized createPolygon() method
class PolygonBlob extends Polygon {
 
  //polygon from a person's blob ,v3ga already does a lot of the work
  void createPolygon() {
    // an arrayList... of arrayLists... of PVectors, person's contours
    ...
    // create contours from all the detected blobs
